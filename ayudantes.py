...
def generar_grafico_compatibilidad(compatibilidad):
    ...
    fig, ax = plt.subplots(figsize=(5, 4))  # Tamaño del gráfico
    
    # Creamos el gráfico de barras con los valores de compatibilidad usando Seaborn
   ...
   # Ajustar las etiquetas del eje Y para mostrar los porcentajes en lugar de decimales
...
def obtener_id_inquilinos(inquilino1, inquilino2, inquilino3, topn):
    ...
    id_inquilinos = []
     ...
     # Iterar sobre los 3 posibles inquilinos ingresados
    for inquilino in [inquilino1, inquilino2, inquilino3]:
        try:
            if inquilino:  # Si se ingresa un valor para el inquilino
